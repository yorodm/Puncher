...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Puncher Demo Installer\n"
      else:
        line="OutputBaseFilename=Puncher Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Puncher Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Puncher installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Puncher Demo installer\n"
     else:
       line="SetupWindowTitle=Puncher installer\n"
