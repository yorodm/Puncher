...
NOTARIZE_BUNDLE_ID=com.OneKnobAudio.Puncher
NOTARIZE_BUNDLE_ID_DEMO=com.OneKnobAudio.Puncher.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Puncher.iss
#  git checkout installer/Puncher.pkgproj
